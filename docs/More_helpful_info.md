...
This rails 8 template will give you a good starting point when working on software engineering projects. The following have already been installed and configured...
...
Written by Ethan Zeigler (TCNJ '20), modified by Jenna Stiesi (TCNJ '22), updated by Logan May (TCNJ '26)
